 ...
 *
 * // This is how a vhaa form works (for simplicity vhaa components have the 'l'-prefix):
 * <l-form>
 *  <form>
 *
 *    <!-- fields -->
 ...
 * </l-form>
 *
 * vhaaForm.formElements[0];                  // Element l-input#a
 * vhaaForm.formElements[1];                  // Element l-input#b1
 * vhaaForm.formElements[2];                  // Element l-input#b2
 * vhaaForm.formElements.a;                   // Element l-input#a
 * vhaaForm.formElements['b[]'];              // Array<Element> [l-input#b1, l-input#b2]
 * vhaaForm.formElements.c;                   // Element l-input#c
 *
 * vhaaForm.formElements[d-g].formElements; // Array<Element>
 *
 * vhaaForm.formElements[d-e].value;          // String
 * vhaaForm.formElements[f-g].value;          // Array<String>
 */
