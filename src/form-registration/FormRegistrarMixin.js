...
const FormRegistrarMixinImplementation = (superclass) =>
    ...
    class FormRegistrarMixin extends FormRegisteringMixin(superclass) {
        ...
        constructor() {
             ...
             * For a regular fieldset (see VhaaFieldset) we expect ".formElements"
            ...
            this._onRequestToChangeFormElementName =
                this._onRequestToChangeFormElementName.bind(this);
        ...
        addFormElement(child, indexToInsertAt) {
            // This is a way to let the child element (a Vhaa-fieldset or Vhaa-field) know, about its parent
        ...
        removeFormElement(child) {
            ...
            if (this._isFormOrFieldset) {
                const { name } = child; // FIXME: <-- ElementWithParentFormGroup should become VhaaFieldWithParentFormGroup so that "name" exists
        ...
        _onRequestToAddFormElement(ev) {
            ...
            if (this.formElements && Array.isArray(this.formElements)) {
                ...
                for (const [i, formElement] of this.formElements.entries()) {
                    ...
                    if (
                        formElement.compareDocumentPosition(child) &
